...
// 
//
// Related Topics 哈希表 数学 字符串 👍 1386 👎 0
...
{
    private static readonly (int sub, string sign)[] Dict = [(1000, "M"), (900, "CM"), (500, "D"), (400, "CD"), (100, "C"), (90, "XC"), (50, "L"), (40, "XL"), (10, "X"), (9, "IX"), (5, "V"), (4, "IV"), (1, "I")];

    public string IntToRoman(int num)
    {
        var sb = new StringBuilder();
        while (num != 0)
            foreach (var (sub, sign) in Dict) {
                if (num < sub) continue;
                sb.Append(sign);
                num -= sub;

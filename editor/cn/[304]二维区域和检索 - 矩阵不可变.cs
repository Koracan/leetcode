...
// 
//
// Related Topics 设计 数组 矩阵 前缀和 👍 619 👎 0
...
public class NumMatrix
{
    ...
    public int SumRegion(int row1, int col1, int row2, int col2) =>
        _prefixSums[row2 + 1, col2 + 1]
      - _prefixSums[row2 + 1, col1]
      - _prefixSums[row1, col2 + 1]
      + _prefixSums[row1, col1];
}
